...
public class Constants {
	...
	public static String REGISTER_SUCCESS_MESSG = "Your Account Has Been Created!";

	public static final List<String> EXPECTED_ACC_SECS_LIST = Arrays.asList("My Account", "My Orders",
