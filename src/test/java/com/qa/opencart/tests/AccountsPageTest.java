...
public class AccountsPageTest extends BaseTest {
	...
	/*
	 * @Test public void accPageHeaderTest() { String header =
	 * accPage.getAccPageHeader(); System.out.println("Acc Page header is: " +
	 * header); Assert.assertEquals(header, Constants.ACC_PAGE_HEADER); }
	 */
	...
	public Object[][] productData() {
		return new Object[][] { { "iMac" }, { "MacBook Pro" }, { "Apple" } };
	}
